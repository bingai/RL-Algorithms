...
if __name__ == '__main__':
	...
	parser.add_argument("--save_dir", default='./models_BatchNorm/', help = 'save directory')	
	parser.add_argument("--save_timesteps", default=2e5, type=float)

	#tensorboard book-keeping: training
	parser.add_argument('--summary_dir', help='directory for storing tensorboard info', default='./models_BatchNorm/tensorboard')
	#tensorboard book-keeping: tratesting
	parser.add_argument('--test_dir', help='directory for storing tensorboard info : test', default='./models_BatchNorm/tensorboard_test')
